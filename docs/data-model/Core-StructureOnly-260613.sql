...
) ENGINE=InnoDB AUTO_INCREMENT=13819 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=440943 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=472425 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `H_SYNC_DataSyncSessions` (
  ...
  `RecordDeleted` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=34823 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `H_Synced_Permits` (
  ...
  `PermitType` int unsigned NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=5176 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5288 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15974 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary view structure for view `Vi_DPA_EntityScenarioPermitsExtraDetail`
--

DROP TABLE IF EXISTS `Vi_DPA_EntityScenarioPermitsExtraDetail`;
/*!50001 DROP VIEW IF EXISTS `Vi_DPA_EntityScenarioPermitsExtraDetail`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `Vi_DPA_EntityScenarioPermitsExtraDetail` AS SELECT 
...
) ENGINE=InnoDB AUTO_INCREMENT=3459 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5695 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=656431 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3065 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5272 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12481 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`HexaBloxdbAdmin`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `Vi_DPA_DriverPermitVehicleTypesDetail` AS select `BaseTable`.`Id` AS `PermitId`,`BaseTable`.`HUBId` AS `PermitHUBId`,`BaseTable`.`DistributorId` AS `PermitDistributorId`,`BaseTable`.`CVOId` AS `PermitCVOId`,`BaseTable`.`VehicleId` AS `PermitVehicleId`,`BaseTable`.`DriverId` AS `PermitDriverId`,`BaseTable`.`ActENUM` AS `PermitActENUM`,`BaseTable`.`PermitIssuerId` AS `PermitPermitIssuerId`,`BaseTable`.`PermitType` AS `PermitPermitType`,`BaseTable`.`Code` AS `PermitCode`,`BaseTable`.`ServiceCategory` AS `PermitServiceCategory`,`BaseTable`.`IssuedDate_UTC` AS `PermitIssuedDate_UTC`,`RJT`.`VehicleType` AS `VehicleType` from (`H_Synced_Permits` `BaseTable` join `H_Synced_DriverPermitVehicleTypes` `RJT` on(((`RJT`.`PermitId` = `BaseTable`.`Id`) and ((0 <> `RJT`.`RecordDeleted`) is not true)))) where ((0 <> `BaseTable`.`RecordDeleted`) is not true) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`HexaBloxdbAdmin`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `Vi_DPA_DriverPermitsExtraDetail` AS select `BaseTable`.`Id` AS `DriverId`,`BaseTable`.`UserId` AS `DriverUserId`,`BaseTable`.`PersonCVOId` AS `DriverPersonCVOId`,`UI`.`Firstname_fsx` AS `DriverUserFirstname_fsx`,`UI`.`Lastname_fsx` AS `DriverUserLastname_fsx`,`UI`.`Username` AS `DriverUserUsername`,`UI`.`Email_fsx` AS `DriverUserEmail_fsx`,`UI`.`Email_hash` AS `DriverUserEmail_hash`,`UI`.`EmailConfirmed` AS `DriverUserEmailConfirmed`,`UI`.`CellPhone_fsx` AS `DriverUserCellPhone_fsx`,`UI`.`CellPhone_hash` AS `DriverUserCellPhone_hash`,`UI`.`CellPhoneConfirmed` AS `DriverUserCellPhoneConfirmed`,`UI`.`IssuedBy` AS `DriverUserIssuedBy`,`RJT`.`HUBId` AS `HUBId`,`RJT`.`DistributorId` AS `DistributorId`,`RJT`.`CVOId` AS `CVOId`,`RJT`.`VehicleId` AS `VehicleId`,`RJT`.`ActENUM` AS `ActENUM`,`RJT`.`PermitIssuerId` AS `PermitIssuerId`,`RJT`.`PermitType` AS `PermitType`,`RJT`.`Code` AS `Code`,`RJT`.`ServiceCategory` AS `ServiceCategory`,`RJT`.`IssuedDate_UTC` AS `IssuedDate_UTC`,`PJT0`.`EntityId` AS `EntityScenarioEntityId`,`PJT0`.`ScenarioId` AS `EntityScenarioScenarioId`,`PEP_0_0`.`Title` AS `EntityScenarioTitle`,`PEP_0_0`.`Address_fsx` AS `EntityScenarioAddress_fsx`,`PEP_0_0`.`City` AS `EntityScenarioCity`,`PEP_0_0`.`Province` AS `EntityScenarioProvince`,`PEP_0_0`.`Country` AS `EntityScenarioCountry`,`PEP_0_0`.`PostalCode_fsx` AS `EntityScenarioPostalCode_fsx`,`PEP_0_0`.`Phone_fsx` AS `EntityScenarioPhone_fsx`,`PEP_0_0`.`FaxNumber_fsx` AS `EntityScenarioFaxNumber_fsx`,`PEP_0_0`.`Email_fsx` AS `EntityScenarioEmail_fsx`,`PEP_0_0`.`Discriminator` AS `EntityScenarioDiscriminator`,`PJT1`.`EntityId` AS `PermitIssuerEntityId`,`PEP_1_0`.`Title` AS `PermitIssuerTitle`,`PEP_1_0`.`Address_fsx` AS `PermitIssuerAddress_fsx`,`PEP_1_0`.`City` AS `PermitIssuerCity`,`PEP_1_0`.`Province` AS `PermitIssuerProvince`,`PEP_1_0`.`Country` AS `PermitIssuerCountry`,`PEP_1_0`.`PostalCode_fsx` AS `PermitIssuerPostalCode_fsx`,`PEP_1_0`.`Phone_fsx` AS `PermitIssuerPhone_fsx`,`PEP_1_0`.`FaxNumber_fsx` AS `PermitIssuerFaxNumber_fsx`,`PEP_1_0`.`Email_fsx` AS `PermitIssuerEmail_fsx`,`PEP_1_0`.`Discriminator` AS `PermitIssuerDiscriminator` from ((((((`H_Synced_Drivers` `BaseTable` join `H_AAA_Synced_UserInfo` `UI` on(((`BaseTable`.`UserId` = `UI`.`Id`) and ((0 <> `UI`.`RecordDeleted`) is not true)))) join `H_Synced_Permits` `RJT` on(((`RJT`.`DriverId` = `BaseTable`.`Id`) and ((0 <> `RJT`.`RecordDeleted`) is not true)))) join `H_AAA_EntityScenarios` `PJT0` on(((`RJT`.`ActENUM` = `PJT0`.`PermittedActENUM`) and ((0 <> `PJT0`.`RecordDeleted`) is not true)))) join `H_AAA_Synced_EntityProfile` `PEP_0_0` on(((`PJT0`.`EntityId` = `PEP_0_0`.`Id`) and ((0 <> `PEP_0_0`.`RecordDeleted`) is not true)))) join `H_Synced_PermitIssuers` `PJT1` on(((`RJT`.`PermitIssuerId` = `PJT1`.`Id`) and ((0 <> `PJT1`.`RecordDeleted`) is not true)))) join `H_AAA_Synced_EntityProfile` `PEP_1_0` on(((`PJT1`.`EntityId` = `PEP_1_0`.`Id`) and ((0 <> `PEP_1_0`.`RecordDeleted`) is not true)))) where ((0 <> `BaseTable`.`RecordDeleted`) is not true) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `Vi_DPA_EntityScenarioPermitsExtraDetail`
--
...
-- Dump completed on 2026-06-13 13:55:29
