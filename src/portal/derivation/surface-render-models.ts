...
export type EnumMappingEntry = { key: string; value: string; color?: string };
export type RenderColumn = { field: string; title: string; type: string; sortable: boolean; enumTable?: string; mapping?: EnumMappingEntry[] };
export type RenderReadModel = { dataSourceType: 'view' | 'table' | 'internalUrlPath' | 'externalUrlPath'; dataSourceValue: string; select: string[]; defaultSortKey: string; defaultPageSize: number; pageSizeOptions: number[]; pendingViewOrder: string | null; processing?: 'backend' | 'frontend' };
...
export const surfaceRenderModels: Record<string, SurfaceRenderModel> = {
  ...
  "system.configurations.actor-configs": {
    ...
    "columns": [
      ...
      {
        "field": "ConfigBaseCode",
        "title": "Config Base Code",
        "type": "text",
        "sortable": true
      },
      {
  ...
  "system.configurations.entity-configs": {
    ...
    "columns": [
      ...
      {
        "field": "PermitIssuerTitle",
        "title": "Permit Issuer Title",
        "type": "text",
        "sortable": true
      },
      {
  ...
  "transport.setup.fare-by-geo-fence": {
    ...
    "columns": [
      ...
      {
        "field": "DestinationGeoFenceBaseTitle",
        "title": "Destination Geo Fence Base Title",
        "type": "text",
        "sortable": true
      },
      {
        "field": "SourceGeoFenceBaseTitle",
        "title": "Source Geo Fence Base Title",
        "type": "text",
        "sortable": true
      }
    ],
